<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/HuellasPerdidas_admin.Master" AutoEventWireup="true" enableEventValidation="false" CodeBehind="PanelAdministrativo.aspx.cs" Inherits="HuellitasPerdidas.GUI.PanelAdministrativo" %>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h4 font-weight-bold mb-0">Administra el registro de los usuarios registrados</span>
                    </div>
                      <div class="col-auto">
                      <div class="icon icon-shape bg-danger text-white rounded-circle shadow">
                          <img class="fas" src="../Recursos/img2/User_75WHITEpx.png" />
                      </div>
                    </div>
                  </div>
                  <p class="mt-3 mb-0 text-muted text-sm">
                      <a href="AdminClientes.aspx" class="btn btn-info">Mostrar usuarios</a>
                  </p>
                </div>
              </div>
            </div>
